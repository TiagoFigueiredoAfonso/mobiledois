...
public class MainActivity extends AppCompatActivity {
    ...
    Button btLogar;
    TextView textViewCriarUsuario, textViewEsqueciSenha;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewCriarUsuario = findViewById(R.id.textViewCriarUsuario);
        textViewEsqueciSenha = findViewById(R.id.textViewEsqueciSenha);

        mAuthLoga = FirebaseAuth.getInstance();


        textViewCriarUsuario.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        textViewEsqueciSenha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(
                        MainActivity.this,
                        MainActivityRecuperaSenha.class
                );
                startActivity(i);
            }
